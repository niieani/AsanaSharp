...
namespace AsanaSharp
{
    ...
    public class EndpointAttribute : Attribute
    {
        ...
        public EndpointAttribute(string endpoint, EndpointMethods methods, params Type[] parameterTypes)
        {
            Endpoint = endpoint;
            Methods = methods;
    ...
    public abstract class ParamAttribute : Attribute
    {
        ...
        public readonly bool DefaultValueByDefault; // TODO
        ...
        public ParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
        {
            ParamType = paramType;
            ParamName = param;
            Type = type;
            DefaultValue = defaultValue;
            DefaultValueByDefault = defaultValueByDefault;
	...
	{
		public GetParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	{
		public CreateParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	{
		public AddToCollectionParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	// TODO: implement
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
	public class SetParamAttribute : ParamAttribute
	{
		public SetParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
	public class UploadParamAttribute : ParamAttribute
	{
		public UploadParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
	public class RemoveFromCollectionParamAttribute : ParamAttribute
	{
		public RemoveFromCollectionParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
	public class RemoveArrayFromCollectionParamAttribute : ParamAttribute
	{
		public RemoveArrayFromCollectionParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
	public class AddArrayToCollectionParamAttribute : ParamAttribute
	{
		public AddArrayToCollectionParamAttribute(ParamType paramType, string param, Type type, string defaultValue = null, bool defaultValueByDefault = false, string internalMemberReference = null, string innerProperty = null)
			: base(paramType, param, type, defaultValue, defaultValueByDefault, internalMemberReference, innerProperty)
		{
		}
	}
	...
	public class AddToCollectionEndpointAttribute : EndpointAttribute
	{
		public AddToCollectionEndpointAttribute(string endpoint) : base(endpoint, EndpointMethods.Post)
		{
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = false)]
	public class RemoveFromCollectionEndpointAttribute : EndpointAttribute
	{
		public RemoveFromCollectionEndpointAttribute(string endpoint) : base(endpoint, EndpointMethods.Post)
		{

		}
	}
	[AttributeUsage(AttributeTargets.All, AllowMultiple = false)]
	public class AddArrayToCollectionEndpointAttribute : EndpointAttribute
	{
		public AddArrayToCollectionEndpointAttribute(string endpoint) : base(endpoint, EndpointMethods.Post)
		{
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = false)]
	public class RemoveArrayFromCollectionEndpointAttribute : EndpointAttribute
	{
		public RemoveArrayFromCollectionEndpointAttribute(string endpoint) : base(endpoint, EndpointMethods.Post)
		{
	...
	[AttributeUsage(AttributeTargets.All, AllowMultiple = false)]
	public class SetEndpointAttribute : EndpointAttribute
	{
		public SetEndpointAttribute(string endpoint) : base(endpoint, EndpointMethods.Post)
		{
    ...
    public class UniversalProperty
    {
        ...
        public string NiceName
        {
            get
            {
                return IsProperty ? _property.Name : _class.Name.Replace("Asana", String.Empty);
            }
        }
    ...
    public static class TypeTools //where T : IList<T>
    {
        ...
        public static string Depluralize(this string pluralWord)
        {
	        ...
	        if (pluralWord.EndsWith("Subtasks")) return pluralWord.Replace("Subtasks","Task").Replace("subtasks", "task");
